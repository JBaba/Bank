...
public class AccountFrm extends javax.swing.JFrame {
    ...
    AccountFrm myframe=ClassicSingleton.getInstanceAccountFrm();
...
//        rowdata = new Object[8];
    ...
    protected void JButtonPerAC_actionPerformed(java.awt.event.ActionEvent event) {
        ...
        JDialog_AddAccount pac = new JDialog_AddAccount(myframe);
    ...
    protected void JButtonDeposit_actionPerformed(java.awt.event.ActionEvent event) {
        ...
        if (selection >= 0) {
            ...
            JDialog_Dialogview dep = new JDialog_Dialogview(myframe, accnr);
    ...
    protected void JButtonWithdraw_actionPerformed(java.awt.event.ActionEvent event) {
        ...
        if (selection >= 0) {
            ...
            JDialog_Dialogview wd = new JDialog_Dialogview(myframe, accnr);
